   ...
   --------------------------------------------------------------------------------
              README file for LibSass Host Native for Windows x64 v1.2.0
   ...
   implementation of LibSass version 3.5.5 for Windows (x64).
   ...
   assemblies, then download and install the Microsoft Visual C++ Redistributable for
   Visual Studio 2017
